...
//require('Controllers/Humidity/route.php');
require('Controllers/MonitorOp/routes.php');
require('Controllers/Huawei/routes.php');
//require('Controllers/PedidosXPull/routes.php');
...
require('Controllers/Controldeplacas/routes.php');
require('Controllers/Memorias/routes.php');

require('Controllers/Reparacion/routes.php');
require('Controllers/SMTDatabase/routes.php');

require('Controllers/P2i/routes.php');
require('Controllers/Ipc/routes.php');
require('Controllers/Email/routes.php');

require('Controllers/ServerMonitor/routes.php');
require('Controllers/Molinete/routes.php');
